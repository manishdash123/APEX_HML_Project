...
def create_data_structure(node_traffic, first_graph, graphs, debug):
    ...
    for t_index, graph in graphs.items():
        for source, destination, data in graph.edges(data=True):
            node_traffic[source][(source, destination)]['records'][int(t_index)]['chunkID'] = data['label']
            node_traffic[source][(source, destination)]['records'][int(t_index)]['type'] = 's'
            node_traffic[destination][(source, destination)]['records'][int(t_index)]['chunkID'] = data['label']
            node_traffic[destination][(source, destination)]['records'][int(t_index)]['type'] = 'r'
